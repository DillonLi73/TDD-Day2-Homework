...
namespace TDD_Day2_Homework.Tests
{
    ...
    public class PotterShoppingCartTests
    {
        ...
        [TestMethod()]
        public void Test_Checkout_Buy_1_Volume1_And_1_Volume2_And_2_Volume3_Checkout_should_be_370()
        {
            // arrange
            var target = new PotterShoppingCart();
            var potterBooks = new List<PotterBook>
        ...
        [TestMethod()]
        public void Test_Checkout_Buy_1_Volume1_And_2_Volume2_And_2_Volume3_Checkout_should_be_460()
        {
            // arrange
            var target = new PotterShoppingCart();
            var potterBooks = new List<PotterBook>
